...
assert.match(red, /X-WR-CALNAME:/);
assert.match(red, /DESCRIPTION:/);
assert.match(red, /LOCATION:/);
assert.match(red, /BEGIN:VALARM/);
assert.doesNotMatch(red + black, /TZID|来源|source|github\.com/i);
